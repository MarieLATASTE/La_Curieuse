 ...
 */
final class Version20210309145831 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Table order_article';
    }

    public function up(Schema $schema) : void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE article ADD orders_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article DROP orders_id');
    }
}
